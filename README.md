...
[![231 catalogued](https://img.shields.io/badge/catalogued-231-ffffff?style=flat-square&labelColor=161616)](#the-vault)
...
<img src="docs/screenshot.png" alt="A Life in Games: a brutalist black-and-yellow catalog showing 231 games catalogued, 217 played, 14 wishlisted, organized into platform shelves from Mobile to N64." width="100%">
...
This is not a stats tracker. It's a **memory book** — 231 games across every
...
| **FULLY OFFLINE** | All 488 assets precached — every cover, screenshot, font, and even React |
...
The service worker precaches all 488 assets (~170MB) on first visit — after
...
data.json       231 games: name, year, genre, description, status, media paths
support.js      the template runtime
sw.js           service worker — precaches all 488 assets
images/         462 covers & gameplay screenshots (researched by Claude Cowork)
...
<div align="center">
<sub>★ A LIFE IN GAMES ★ 231 CATALOGUED ★ 217 PLAYED ★ 14 ON THE WISHLIST ★</sub>
